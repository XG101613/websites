...
Shizuku可以帮助普通应用程序使用 adb/bioldroot API，Java you app_process
...
（Pie+）执行本机程序`合约制造部` ([看这里](https://android.googlesource.com/platform/frameworks/native/+/pie-release/cmds/cmd/))
...
2. ap通过绑定器与 Shizuku是你的，Shizuku是你的
